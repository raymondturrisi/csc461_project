...
def get_trial_params(trial: optuna.Trial):
    ...
    env_config = {
        "id":"llvm-ic-v0",
        "observation_space":trial.suggest_categorical("observation_space",["InstCount", "Inst2vec", "Autophase"]),
...
def main():
    ...
    study = optuna.create_study(study_name=f"dqn_3", direction="maximize", storage=database_url, load_if_exists=True)
